...
public class CategoryActivity extends AppCompatActivity {
    ...
    private void initIntent(){
        ...
        List<Categories.Category> categories = (List<Categories.Category>)
                intent.getSerializableExtra(HomeActivity.EXTRA_CATEGORY);
        int postion = intent.getIntExtra(HomeActivity.EXTRA_POSITION,0);
